...
//  SortTestHelper::testSort("Selection Sort", selectionSort, arr, n); // n = 10000, 0.08399s
    
    SortTestHelper::testSort("Selection Sort", selectionSort, arr, n); // n = 100000, 8.2208s, 100倍
//    selectionSort(arr, n);
